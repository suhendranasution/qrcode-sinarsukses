...
-- 4. Run the script to create the users table
...
-- ============================================================================
-- STEP 2: Create trigger for automatic timestamp updates
-- ============================================================================
...
-- IMPORTANT NOTES:
-- ============================================================================
-- 1. This script uses SHA-256 password hashing
-- 2. Default credentials:
--    - superadmin@example.com / admin123 (Super Admin)
--    - admin@example.com / admin123 (Admin)
-- 3. New users created through the UI will be stored in this table
-- 4. The password_hash field contains hashed passwords, not plain text
-- ============================================================================